...
namespace Sample.Automation.Solution.Application.Pages
{
    public class SideMenuElements
    {
        ...
        private readonly string _jsonFilePath = AppConfigs.ObjectRepository + @"SideMenu.json";
        protected readonly AutomatedElement _NewCustomer;

        public SideMenuElements(IWebDriver driver)
        {
            _driver = driver;
